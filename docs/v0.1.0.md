...
- Explicit artifact paths are absolute, validated, and written with user-only permissions where POSIX permissions apply.
...
- Any license file, until the owner approves a license.
